...
function t1069_init(recId){var rec=document.getElementById('rec'+recId);if(!rec)return;var container=rec.querySelector('.t1069');if(!container)return;var rows=rec.querySelectorAll('.t1069__row');Array.prototype.forEach.call(rows,function(row){var titles=row.querySelectorAll('.t1069__title');var descriptions=row.querySelectorAll('.t1069__descr');var prices=row.querySelectorAll('.t1069__price');var subtitles=row.querySelectorAll('.t1069__subtitle');if(titles.length>0)t1069_equalHeight(titles);if(descriptions.length>0)t1069_equalHeight(descriptions);if(prices.length>0)t1069_equalHeight(prices);if(subtitles.length>0)t1069_equalHeight(subtitles)})}
